...
/**
 * Athugar hvort strengur sé palindrome, s.s. sé eins fram og til baka.
 * @param {string} str Strengur sem á að athuga hvort sé palindrome
 * @returns {boolean} true ef strengur er palindrome, annars false
 */
